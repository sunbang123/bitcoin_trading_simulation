...
public enum ErrorCode {
    ...
    USER_NOT_FOUND(HttpStatus.NOT_FOUND, "1101", "사용자를 찾을 수 없습니다."),
    ...
    TOKEN_MISSING(HttpStatus.UNAUTHORIZED, "1202", "JWT 토큰이 없습니다."),
    ...
    INSUFFICIENT_BALANCE(HttpStatus.BAD_REQUEST, "1303", "보유 원화가 부족합니다."),
    INSUFFICIENT_ASSET(HttpStatus.BAD_REQUEST, "1304", "보유 코인 수량이 부족합니다."),
    PRICE_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "1305", "실시간 가격을 아직 수신하지 못했습니다."),
    ...
    I_DONT_KNOW(HttpStatus.BAD_REQUEST, "2000", "알 수 없는 오류입니다.");
